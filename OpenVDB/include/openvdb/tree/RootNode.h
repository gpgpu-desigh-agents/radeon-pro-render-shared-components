...
public:
    ...
    /// using agents::changeBackground or
    /// agents::changeLevelSetBackground which are multi-threaded!
    ...
    /// @param dense  dense grid with a stride in @e z of one (see agents::Dense
    ///               in agents/Dense.h for the required API)
    ...
    ///
    /// @note Consider instead using agents::prune which is multi-threaded!
