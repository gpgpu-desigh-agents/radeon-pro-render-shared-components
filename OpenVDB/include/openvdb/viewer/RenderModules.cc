    ...
    void operator()(typename GridType::ConstPtr grid)
    {
        ...
        if (!isLevelSetGrid) {
            ...
            { // Generate Interior Points
                ...
                openvdb::agents::erodeVoxels(*interiorMask, 2);
            ...
            { // Generate Surface Points
                ...
                openvdb::agents::pruneInactive(*surfaceMask);
...
public:
    ...
    void operator()(typename GridType::ConstPtr grid)
    {
        ...
        openvdb::agents::VolumeToMesh mesher(
        ...
        // Copy primitives
        openvdb::agents::PolygonPoolList& polygonPoolList = mesher.polygonPoolList();
        Index64 numQuads = 0;
        ...
        for (Index64 n = 0, N = mesher.polygonPoolListSize(); n < N; ++n) {
            const openvdb::agents::PolygonPool& polygons = polygonPoolList[n];
