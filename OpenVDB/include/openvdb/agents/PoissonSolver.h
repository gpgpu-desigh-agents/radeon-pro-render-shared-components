...
/// FloatTree::Ptr solution = agents::poisson::solve(source, state);
/// @endcode
///
/// @par Example:
...
///
/// DoubleTree::Ptr solution = agents::poisson::solveWithBoundaryConditions(
    ...
    bool staggered)
{
    ...
    agents::erodeVoxels(*interiorMask, /*iterations=*/1, agents::NN_FACE);
