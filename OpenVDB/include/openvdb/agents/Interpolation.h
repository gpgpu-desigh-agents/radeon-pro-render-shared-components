...
/// with agents::GridTransformer should operate in voxel space and must adhere to
...
template <typename GridT,
          typename MaskT,
          typename SamplerT = agents::BoxSampler,
...
protected:
    ...
    AccT mAcc;
    agents::DualGridSampler<AccT, SamplerT> mSampler;
