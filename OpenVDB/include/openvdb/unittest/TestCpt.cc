...
public:
    ...
    CPPUNIT_TEST(testCptAgent);                  // Cpt agent
    CPPUNIT_TEST(testCptMaskedAgent);
...
TestCpt::testCptAgent()
{
    ...
    // run the agent
    typedef openvdb::agents::Cpt<FloatGrid> FloatCpt;
    FloatCpt cpt(*grid);
...
TestCpt::testCptMaskedAgent()
{
    ...
    // run the agent
    //typedef openvdb::agents::Cpt<FloatGrid> FloatCpt;//fails because MaskT defaults to MaskGrid
    typedef openvdb::agents::Cpt<FloatGrid, BoolGrid> FloatCpt;
