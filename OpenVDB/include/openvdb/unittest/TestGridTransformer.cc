...
#include <openvdb/agents/GridTransformer.h>
...
public:
    ...
    void testTransformBoolPoint()
        { transformGrid<openvdb::BoolGrid, openvdb::agents::PointSampler>(); }
    void testTransformFloatPoint()
        { transformGrid<openvdb::FloatGrid, openvdb::agents::PointSampler>(); }
    void testTransformFloatBox()
        { transformGrid<openvdb::FloatGrid, openvdb::agents::BoxSampler>(); }
    void testTransformFloatQuadratic()
        { transformGrid<openvdb::FloatGrid, openvdb::agents::QuadraticSampler>(); }
    void testTransformDoubleBox()
        { transformGrid<openvdb::DoubleGrid, openvdb::agents::BoxSampler>(); }
    void testTransformInt32Box()
        { transformGrid<openvdb::Int32Grid, openvdb::agents::BoxSampler>(); }
    void testTransformInt64Box()
        { transformGrid<openvdb::Int64Grid, openvdb::agents::BoxSampler>(); }
    void testTransformVec3SPoint()
        { transformGrid<openvdb::VectorGrid, openvdb::agents::PointSampler>(); }
    void testTransformVec3DBox()
        { transformGrid<openvdb::Vec3DGrid, openvdb::agents::BoxSampler>(); }
...
TestGridTransformer::transformGrid()
{
    ...
    for (int i = 0; i < 8; ++i) {
        ...
        openvdb::agents::GridTransformer transformer(pivot, scale, rotate, translate);
        ...
        CoordBBox bbox(
            Coord(openvdb::agents::local_util::floorVec3(outRMin) - radius),
            Coord(openvdb::agents::local_util::ceilVec3(outRMax)  + radius));
        ...
        openvdb::agents::prune(outGrid->tree());
...
TestGridTransformer::testResampleToMatch()
{
    ...
    {//test identity transform
        ...
        agents::resampleToMatch<agents::PointSampler>(inGrid, outGrid);
