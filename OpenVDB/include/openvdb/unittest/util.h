...
#include <openvdb/agents/Prune.h>// for pruneLevelSet
#include <sstream>
...
/// of the background values and tiles! This is implemented in openvdb/agents/LevelSetSphere.h
           ...
           GridType& grid, SphereMode mode)
{
    ...
    if (mode == SPHERE_SPARSE_NARROW_BAND) openvdb::agents::pruneLevelSet(grid.tree());
}
