...
public:
    ...
    CPPUNIT_TEST(testDivergenceAgent);                  // Divergence agent
    CPPUNIT_TEST(testDivergenceMaskedAgent);            // Divergence agent
    ...
    void testDivergenceAgent();
    void testDivergenceMaskedAgent();
...
void
TestDivergence::testDivergenceAgent()
{
    ...
    FloatGrid::Ptr divGrid = agents::divergence(*inGrid);
...
void
TestDivergence::testDivergenceMaskedAgent()
{
    using namespace openvdb;
    ...
    FloatGrid::Ptr divGrid = agents::divergence(*inGrid, *maskGrid);
