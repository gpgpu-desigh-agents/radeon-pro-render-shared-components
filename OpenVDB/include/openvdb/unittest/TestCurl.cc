...
public:
    ...
    CPPUNIT_TEST(testCurlAgent);                  // Gradient agent
    CPPUNIT_TEST(testCurlMaskedAgent);            // Gradient agent
...
TestCurl::testCurlAgent()
{
    ...
    VectorGrid::Ptr curl_grid = agents::curl(*inGrid);
...
TestCurl::testCurlMaskedAgent()
{
    ...
    VectorGrid::Ptr curl_grid = agents::curl(*inGrid, *maskGrid);
