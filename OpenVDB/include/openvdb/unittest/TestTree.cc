...
#include <openvdb/agents/ValueTransformer.h> // for agents::setValueOnMin(), et al.
...
TestTree::testChangeBackground()
{
    ...
    {//changeBackground
        GridT::Ptr grid = openvdb::agents::createLevelSetSphere<GridT>(
        ...
        openvdb::agents::changeBackground(tree, background);
    ...
    {//changeLevelSetBackground
        ...
        openvdb::agents::changeAsymmetricLevelSetBackground(tree, v1, v2);
...
TestTree::testSetValue()
{
    ...
    openvdb::agents::setValueOnSum(tree, c0, background);
...
TestTree::testTopologyIntersection()
{
    {//no overlapping voxels
        ...
        openvdb::agents::pruneInactive(tree1);
        CPPUNIT_ASSERT(tree1.empty());
    }
...
TestTree::testTopologyDifference()
{
    ...
    {//active tile
        ...
        openvdb::agents::pruneInactive(tree0);
        CPPUNIT_ASSERT_EQUAL( openvdb::Index32(1), tree0.leafCount() );
        CPPUNIT_ASSERT_EQUAL( openvdb::Index64(1), tree0.activeVoxelCount() );
        CPPUNIT_ASSERT(!tree1.empty());
    }
...
TestTree::testSignedFloodFill()
{
    ...
    {//first test flood filling of a leaf node
        ...
        openvdb::agents::SignedFloodFillOp<TreeT> sff(fill0, fill1);
    ...
    openvdb::agents::signedFloodFill(tree);
...
TestTree::testPruneInactive()
{
    ...
    CPPUNIT_ASSERT(tree.empty());
    openvdb::agents::prune(tree);
    CPPUNIT_ASSERT(tree.empty());
    openvdb::agents::pruneInactive(tree);
    CPPUNIT_ASSERT(tree.empty());
...
TestTree::testPruneLevelSet()
{
    ...
    */
    ...
    openvdb::agents::pruneLevelSet(tree);
...
TestTree::testNodeCount()
{
    ...
    auto  grid = openvdb::agents::createLevelSetSphere<openvdb::FloatGrid>(radius, center, radius/dim, halfWidth);
