...
public:
    ...
    CPPUNIT_TEST(testMeanCurvatureAgent);                  // MeanCurvature agent
    CPPUNIT_TEST(testMeanCurvatureMaskedAgent);            // MeanCurvature agent
    ...
    void testMeanCurvatureAgent();
    void testMeanCurvatureMaskedAgent();
...
void
TestMeanCurvature::testMeanCurvatureAgent()
{
    using namespace openvdb;
    ...
    CPPUNIT_ASSERT(!tree.empty());
    FloatGrid::Ptr curv = agents::meanCurvature(*grid);
...
void
TestMeanCurvature::testMeanCurvatureMaskedAgent()
{
    using namespace openvdb;
    ...
    FloatGrid::Ptr curv = agents::meanCurvature(*grid, *maskGrid);
    FloatGrid::ConstAccessor accessor = curv->getConstAccessor();
...
TestMeanCurvature::testCurvatureStencil()
{
    ...
    {// test sparse level set sphere
      ...
      FloatGrid::Ptr sphere = agents::createLevelSetSphere<FloatGrid>(float(r), C, float(voxelSize));
