...
TestPointGroup::testSet()
{
    ...
    openvdb::agents::PointIndexGrid::Ptr pointIndexGrid =
        openvdb::agents::createPointIndexGrid<openvdb::agents::PointIndexGrid>(pointList, *transform);
    ...
    agents::PointIndexGrid::Ptr tmpIndexGrid = agents::PointIndexGrid::create();
