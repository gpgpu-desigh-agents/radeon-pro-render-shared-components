...
#include <openvdb/agents/ParticleAtlas.h>
...
TestParticleAtlas::testParticleAtlas()
{
    ...
    typedef openvdb::agents::ParticleAtlas<> ParticleAtlas;
    ...
    typedef openvdb::agents::ParticleAtlas<>::Iterator ParticleAtlasIterator;
