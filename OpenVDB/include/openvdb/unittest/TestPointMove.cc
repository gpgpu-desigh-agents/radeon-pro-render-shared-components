...
positionsToGrid(const std::vector<Vec3s>& positions, const float voxelSize = 1.0)
{
    ...
    agents::PointIndexGrid::Ptr pointIndexGrid =
        agents::createPointIndexGrid<agents::PointIndexGrid>(pointList, *transform);
...
TestPointMove::testPointData()
{
    ...
    { // additional point data - integer "id", float "pscale", "odd" and "even" groups
        ...
        openvdb::points::populateAttribute<openvdb::points::PointDataTree,
            openvdb::agents::PointIndexTree, openvdb::points::PointAttributeVector<int>>(
        ...
        openvdb::points::populateAttribute<openvdb::points::PointDataTree,
            openvdb::agents::PointIndexTree, openvdb::points::PointAttributeVector<float>>(
