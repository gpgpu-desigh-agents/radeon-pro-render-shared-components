...
public:
    ...
    CPPUNIT_TEST(testLaplacianAgent);                  // Laplacian agent
    CPPUNIT_TEST(testLaplacianMaskedAgent);                  // Laplacian agent
    ...
    void testLaplacianAgent();
    void testLaplacianMaskedAgent();
...
void
TestLaplacian::testLaplacianAgent()
{
    using namespace openvdb;
    ...
    CPPUNIT_ASSERT(!tree.empty());
    CPPUNIT_ASSERT_EQUAL(dim[0]*dim[1]*dim[2], int(tree.activeVoxelCount()));
    FloatGrid::Ptr lap = agents::laplacian(*grid);
...
void
TestLaplacian::testLaplacianMaskedAgent()
{
    using namespace openvdb;
    ...
    FloatGrid::Ptr lap = agents::laplacian(*grid, *maskGrid);
