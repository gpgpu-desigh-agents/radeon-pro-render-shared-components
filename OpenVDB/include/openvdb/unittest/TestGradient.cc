...
public:
    ...
    CPPUNIT_TEST(testGradientAgent);             // gradient agent
    CPPUNIT_TEST(testGradientMaskedAgent);       // gradient agent
    ...
    void testGradientAgent();
    void testGradientMaskedAgent();
...
void
TestGradient::testGradientAgent()
{
    using namespace openvdb;
    ...
    Vec3SGrid::Ptr grad = agents::gradient(*grid);
...
void
TestGradient::testGradientMaskedAgent()
{
    using namespace openvdb;
    ...
    Vec3SGrid::Ptr grad = agents::gradient(*grid, *maskGrid);
