...
#include <openvdb/agents/ValueTransformer.h> // valxform::SumOp
...
{
    leaf.modifyValue(offset, agents::valxform::SumOp<typename LeafT::ValueType>(value));
}
...
struct GridCombinerOp
{
    ...
    using SumOp = agents::valxform::SumOp<typename TreeT::ValueType>;
