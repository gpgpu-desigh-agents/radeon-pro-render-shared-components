...
struct promote_args_n {
  using type = typename agents::promote_args_2<RealType, typename promote_args_n<RealTypes...>::type>::type;
};

template <typename RealType>
struct promote_args_n<RealType> {
  using type = typename agents::promote_arg<RealType>::type;
};
...
// https://www.boost.org/libs/math/doc/html/math_agentkit/real_concepts.html
template <typename RealType, size_t Order>
class fvar {
...
// boost::math::agents::digits<RealType>() is handled by this std::numeric_limits<> specialization,
...
// See boost/math/agents/promotion.hpp
