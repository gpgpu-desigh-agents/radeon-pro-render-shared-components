    ...
    namespace math
    {
       namespace detail
       {
        ...
        inline T    acosh_imp(const T x, const Policy& pol)
        {
            ...
            else if    ((x - 1) >= agents::root_epsilon<T>())
            {
        ...
        template<typename T, typename Policy>
        inline typename agents::promote_args<T>::type acosh(T x, const Policy&)
        {
        ...
        template<typename T>
        inline typename agents::promote_args<T>::type acosh(T x)
        {
