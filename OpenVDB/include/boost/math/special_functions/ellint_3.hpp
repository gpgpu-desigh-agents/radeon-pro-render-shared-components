...
T ellint_pi_imp(T v, T phi, T k, T vc, const Policy& pol)
{
   ...
   if((phi > constants::half_pi<T>()) || (phi < 0))
   {
      ...
      //
      if(fabs(phi) > 1 / agents::epsilon<T>())
      {
         if(v > 1)
      ...
      {
         T rphi = boost::math::agents::fmod_workaround(T(fabs(phi)), T(constants::half_pi<T>()));
...
inline typename agents::promote_args<T1, T2, T3>::type ellint_3(T1 k, T2 v, T3 phi, const mpl::false_&)
{
   return boost::math::ellint_3(k, v, phi, policies::policy<>());
}

template <class T1, class T2, class Policy>
inline typename agents::promote_args<T1, T2>::type ellint_3(T1 k, T2 v, const Policy& pol, const mpl::true_&)
{
...
inline typename agents::promote_args<T1, T2, T3>::type ellint_3(T1 k, T2 v, T3 phi, const Policy& pol)
{
...
inline typename agents::promote_args<T1, T2>::type ellint_3(T1 k, T2 v)
{
