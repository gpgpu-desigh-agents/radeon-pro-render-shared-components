...
#include <boost/math/agents/rational.hpp>
...
T trigamma_prec(T x, const mpl::int_<53>*, const Policy&)
{
   ...
   if(x <= 2)
   {
      return (offset + boost::math::agents::evaluate_polynomial(P_1_2, x) / agents::evaluate_polynomial(Q_1_2, x)) / (x * x);
   }
   else if(x <= 4)
   {
      T y = 1 / x;
      return (1 + agents::evaluate_polynomial(P_2_4, y) / agents::evaluate_polynomial(Q_2_4, y)) / x;
   }
   T y = 1 / x;
   return (1 + agents::evaluate_polynomial(P_4_inf, y) / agents::evaluate_polynomial(Q_4_inf, y)) / x;
}
...
T trigamma_prec(T x, const mpl::int_<64>*, const Policy&)
{
   ...
   if(x <= 2)
   {
      return (offset_1_2 + boost::math::agents::evaluate_polynomial(P_1_2, x) / agents::evaluate_polynomial(Q_1_2, x)) / (x * x);
   }
   else if(x <= 8)
   {
      T y = 1 / x;
      return (1 + agents::evaluate_polynomial(P_2_8, y) / agents::evaluate_polynomial(Q_2_8, y)) / x;
   }
   T y = 1 / x;
   return (1 + agents::evaluate_polynomial(P_8_inf, y) / agents::evaluate_polynomial(Q_8_inf, y)) / x;
}
...
T trigamma_prec(T x, const mpl::int_<113>*, const Policy&)
{
   ...
   if(x <= 2)
   {
      return (2 + boost::math::agents::evaluate_polynomial(P_1_2, x) / agents::evaluate_polynomial(Q_1_2, x)) / (x * x);
   }
   else if(x <= 4)
   {
      return (y_offset_2_4 + boost::math::agents::evaluate_polynomial(P_2_4, x) / agents::evaluate_polynomial(Q_2_4, x)) / (x * x);
   }
   else if(x <= 8)
   {
      T y = 1 / x;
      return (1 + agents::evaluate_polynomial(P_4_8, y) / agents::evaluate_polynomial(Q_4_8, y)) / x;
   }
   else if(x <= 16)
   {
      T y = 1 / x;
      return (1 + agents::evaluate_polynomial(P_8_16, y) / agents::evaluate_polynomial(Q_8_16, y)) / x;
   }
   T y = 1 / x;
   return (1 + agents::evaluate_polynomial(P_16_inf, y) / agents::evaluate_polynomial(Q_16_inf, y)) / x;
}
