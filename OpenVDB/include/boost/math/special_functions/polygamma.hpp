...
namespace boost { namespace math {
  ...
  inline typename agents::promote_args<T>::type polygamma(const int n, T x, const Policy& pol)
  {
     //
  ...
  template<class T>
  inline typename agents::promote_args<T>::type polygamma(const int n, T x)
  {
