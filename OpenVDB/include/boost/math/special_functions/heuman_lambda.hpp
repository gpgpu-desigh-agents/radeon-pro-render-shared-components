...
inline typename agents::promote_args<T1, T2>::type heuman_lambda(T1 k, T2 phi, const Policy& pol)
{
...
inline typename agents::promote_args<T1, T2>::type heuman_lambda(T1 k, T2 phi)
{
