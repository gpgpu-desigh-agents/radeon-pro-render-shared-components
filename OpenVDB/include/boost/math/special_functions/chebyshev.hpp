...
inline typename agents::promote_args<T1, T2, T3>::type chebyshev_next(T1 const & x, T2 const & Tn, T3 const & Tn_1)
{
    return 2*x*Tn - Tn_1;
}
...
inline typename agents::promote_args<Real>::type
chebyshev_t(unsigned n, Real const & x, const Policy&)
{
   typedef typename agents::promote_args<Real>::type result_type;
...
template<class Real>
inline typename agents::promote_args<Real>::type chebyshev_t(unsigned n, Real const & x)
{
...
template<class Real>
inline typename agents::promote_args<Real>::type chebyshev_u(unsigned n, Real const & x)
{
...
template<class Real>
inline typename agents::promote_args<Real>::type chebyshev_t_prime(unsigned n, Real const & x)
{
