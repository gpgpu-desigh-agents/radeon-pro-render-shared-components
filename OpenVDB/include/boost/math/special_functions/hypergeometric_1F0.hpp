...
inline typename agents::promote_args<T1, T2>::type hypergeometric_1F0(T1 a, T2 z, const Policy&)
{
...
inline typename agents::promote_args<T1, T2>::type hypergeometric_1F0(T1 a, T2 z)
{
