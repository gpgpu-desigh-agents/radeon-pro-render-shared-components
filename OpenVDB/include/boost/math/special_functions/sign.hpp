...
{ 
   ...
   typedef typename agents::promote_args_permissive<T>::type result_type;
...
template <class T> typename agents::promote_args_permissive<T>::type (changesign)(const T& x)
...
inline typename agents::promote_args_permissive<T, U>::type 
   copysign BOOST_NO_MACRO_EXPAND(const T& x, const U& y)
{
   BOOST_MATH_STD_USING
   typedef typename agents::promote_args_permissive<T, U>::type result_type;
