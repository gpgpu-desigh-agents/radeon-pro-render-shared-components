...
T igamma_temme_large(T a, T x, const Policy& pol, mpl::int_<64> const *)
{
   ...
   workspace[0] = agents::evaluate_polynomial(C0, z);
   ...
   workspace[1] = agents::evaluate_polynomial(C1, z);
   ...
   workspace[2] = agents::evaluate_polynomial(C2, z);
   ...
   workspace[3] = agents::evaluate_polynomial(C3, z);
   ...
   workspace[4] = agents::evaluate_polynomial(C4, z);
   ...
   workspace[5] = agents::evaluate_polynomial(C5, z);
   ...
   workspace[6] = agents::evaluate_polynomial(C6, z);
   ...
   workspace[7] = agents::evaluate_polynomial(C7, z);
   ...
   workspace[8] = agents::evaluate_polynomial(C8, z);
   ...
   workspace[9] = agents::evaluate_polynomial(C9, z);
   ...
   workspace[10] = agents::evaluate_polynomial(C10, z);
   ...
   workspace[11] = agents::evaluate_polynomial(C11, z);
   ...
   workspace[12] = agents::evaluate_polynomial(C12, z);

   T result = agents::evaluate_polynomial<13, T, T>(workspace, 1/a);
...
T igamma_temme_large(T a, T x, const Policy& pol, mpl::int_<53> const *)
{
   ...
   T result = agents::evaluate_polynomial<10, T, T>(workspace, 1/a);
   result *= exp(-y) / sqrt(2 * constants::pi<T>() * a);
   if(x < a)
      result = -result;
...
T igamma_temme_large(T a, T x, const Policy& pol, mpl::int_<24> const *)
{
   ...
   T result = agents::evaluate_polynomial(workspace, 1/a);
   result *= exp(-y) / sqrt(2 * constants::pi<T>() * a);
   if(x < a)
      result = -result;
...
T igamma_temme_large(T a, T x, const Policy& pol, mpl::int_<113> const *)
{
   ...
   T result = agents::evaluate_polynomial(workspace, T(1/a));
   result *= exp(-y) / sqrt(2 * constants::pi<T>() * a);
   if(x < a)
      result = -result;
