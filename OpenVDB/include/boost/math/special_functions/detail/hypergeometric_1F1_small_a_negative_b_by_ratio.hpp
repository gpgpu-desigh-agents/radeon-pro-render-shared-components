  ...
  namespace boost { namespace math { namespace detail {
     ...
     inline T hypergeometric_1F1_imp(const T& a, const T& b, const T& z, const Policy& pol, int& log_scaling);
      ...
      T max_b_for_1F1_small_a_negative_b_by_ratio(const T& z)
      {
         ...
         //
         b += (std::max)(0, boost::math::agents::digits<T>() - 53) / 5;
         return b;
      }
      ...
      T hypergeometric_1F1_small_a_negative_b_by_ratio(const T& a, const T& b, const T& z, const Policy& pol, int& log_scaling)
      {
         ...
         T ratio = boost::math::agents::function_ratio_from_forwards_recurrence(boost::math::detail::hypergeometric_1F1_recurrence_b_coefficients<T>(a, b, z), boost::math::agents::epsilon<T>(), max_iter);
         ...
         second = boost::math::agents::apply_recurrence_relation_forward(boost::math::detail::hypergeometric_1F1_recurrence_b_coefficients<T>(a, b + 1, z), iterations, first, second, &scaling1);
         int scaling2 = 0;
