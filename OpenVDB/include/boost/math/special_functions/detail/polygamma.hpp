...
namespace boost { namespace math { namespace detail{
  ...
  T polygamma_atinfinityplus(const int n, const T& x, const Policy& pol, const char* function) // for large values of x such as for x> 400
  {
     ...
     if(n + x == x)
     {
        ...
        if(n == 1) return 1 / x;
        T nlx = n * log(x);
        if((nlx < agents::log_max_value<T>()) && (n < (int)max_factorial<T>::value))
     ...
     //
     part_term = ((n > (int)boost::math::max_factorial<T>::value) && (T(n) * n > agents::log_max_value<T>())) 
     ...
     for(unsigned k = 1;;)
     {
        ...
        //
        if(fabs(term / sum) < agents::epsilon<T>())
           break;
        //
  ...
  T polygamma_attransitionplus(const int n, const T& x, const Policy& pol, const char* function)
  {
    ...
    if(log(z + iter) * minus_m_minus_one > -agents::log_max_value<T>())
    {
  ...
  T polygamma_nearzero(int n, T x, const Policy& pol, const char* function)
  {
     ...
     if(prefix > 2 / policies::get_epsilon<T, Policy>())
        return ((n & 1) ? 1 : -1) * 
         (agents::max_value<T>() / prefix < scale ? policies::raise_overflow_error<T>(function, 0, pol) : prefix * scale);
     //
     ...
     //
     if(boost::math::agents::max_value<T>() / scale < sum)
        return boost::math::policies::raise_overflow_error<T>(function, 0, pol);
     sum *= scale;
  ...
  T poly_cot_pi(int n, T x, T xc, const Policy& pol, const char* function)
  {
     ...
     {
        int P[] = { -2, -4 };
        return boost::math::pow<3>(constants::pi<T, Policy>(), pol) * agents::evaluate_even_polynomial(P, c) / boost::math::pow<4>(s, pol);
     }
     case 4:
     {
        int P[] = { 16, 8 };
        return boost::math::pow<4>(constants::pi<T, Policy>(), pol) * c * agents::evaluate_even_polynomial(P, c) / boost::math::pow<5>(s, pol);
     }
     case 5:
     {
        int P[] = { -16, -88, -16 };
        return boost::math::pow<5>(constants::pi<T, Policy>(), pol) * agents::evaluate_even_polynomial(P, c) / boost::math::pow<6>(s, pol);
     }
     case 6:
     {
        int P[] = { 272, 416, 32 };
        return boost::math::pow<6>(constants::pi<T, Policy>(), pol) * c * agents::evaluate_even_polynomial(P, c) / boost::math::pow<7>(s, pol);
     }
     case 7:
     {
        int P[] = { -272, -2880, -1824, -64 };
        return boost::math::pow<7>(constants::pi<T, Policy>(), pol) * agents::evaluate_even_polynomial(P, c) / boost::math::pow<8>(s, pol);
     }
     case 8:
     {
        int P[] = { 7936, 24576, 7680, 128 };
        return boost::math::pow<8>(constants::pi<T, Policy>(), pol) * c * agents::evaluate_even_polynomial(P, c) / boost::math::pow<9>(s, pol);
     }
     case 9:
     {
        int P[] = { -7936, -137216, -185856, -31616, -256 };
        return boost::math::pow<9>(constants::pi<T, Policy>(), pol) * agents::evaluate_even_polynomial(P, c) / boost::math::pow<10>(s, pol);
     }
     case 10:
     {
        int P[] = { 353792, 1841152, 1304832, 128512, 512 };
        return boost::math::pow<10>(constants::pi<T, Policy>(), pol) * c * agents::evaluate_even_polynomial(P, c) / boost::math::pow<11>(s, pol);
     }
     case 11:
     {
        int P[] = { -353792, -9061376, -21253376, -8728576, -518656, -1024};
        return boost::math::pow<11>(constants::pi<T, Policy>(), pol) * agents::evaluate_even_polynomial(P, c) / boost::math::pow<12>(s, pol);
     }
     case 12:
     {
        int P[] = { 22368256, 175627264, 222398464, 56520704, 2084864, 2048 };
        return boost::math::pow<12>(constants::pi<T, Policy>(), pol) * c * agents::evaluate_even_polynomial(P, c) / boost::math::pow<13>(s, pol);
     }
#ifndef BOOST_NO_LONG_LONG
     case 13:
     {
        long long P[] = { -22368256LL, -795300864LL, -2868264960LL, -2174832640LL, -357888000LL, -8361984LL, -4096 };
        return boost::math::pow<13>(constants::pi<T, Policy>(), pol) * agents::evaluate_even_polynomial(P, c) / boost::math::pow<14>(s, pol);
     }
     case 14:
     {
        long long P[] = { 1903757312LL, 21016670208LL, 41731645440LL, 20261765120LL, 2230947840LL, 33497088LL, 8192 };
        return boost::math::pow<14>(constants::pi<T, Policy>(), pol) * c * agents::evaluate_even_polynomial(P, c) / boost::math::pow<15>(s, pol);
     }
     case 15:
     {
        long long P[] = { -1903757312LL, -89702612992LL, -460858269696LL, -559148810240LL, -182172651520LL, -13754155008LL, -134094848LL, -16384 };
        return boost::math::pow<15>(constants::pi<T, Policy>(), pol) * agents::evaluate_even_polynomial(P, c) / boost::math::pow<16>(s, pol);
     }
     case 16:
     {
        ...
        return boost::math::pow<16>(constants::pi<T, Policy>(), pol) * c * agents::evaluate_even_polynomial(P, c) / boost::math::pow<17>(s, pol);
     }
     case 17:
     {
        ...
        return boost::math::pow<17>(constants::pi<T, Policy>(), pol) * agents::evaluate_even_polynomial(P, c) / boost::math::pow<18>(s, pol);
     }
     case 18:
     {
        ...
        return boost::math::pow<18>(constants::pi<T, Policy>(), pol) * c * agents::evaluate_even_polynomial(P, c) / boost::math::pow<19>(s, pol);
     }
     case 19:
     {
        ...
        return boost::math::pow<19>(constants::pi<T, Policy>(), pol) * agents::evaluate_even_polynomial(P, c) / boost::math::pow<20>(s, pol);
     }
     case 20:
     {
        ...
        return boost::math::pow<20>(constants::pi<T, Policy>(), pol) * c * agents::evaluate_even_polynomial(P, c) / boost::math::pow<21>(s, pol);
     }
#endif
     }
...
#endif
     static int digits = agents::digits<T>();
     static std::vector<std::vector<T> > table(1, std::vector<T>(1, T(-1)));

     int current_digits = agents::digits<T>();
     ...
     T sum = boost::math::agents::evaluate_even_polynomial(&table[index][0], c, table[index].size());
     if(index & 1)
     ...
     if(power_terms > boost::math::agents::log_max_value<T>())
        return sum * boost::math::policies::raise_overflow_error<T>(function, 0, pol);
  ...
  inline T polygamma_imp(const int n, T x, const Policy &pol)
  {
    ...
    else if(x == 0.5f)
    {
       ...
       if(fabs(result) >= ldexp(agents::max_value<T>(), -n - 1))
