...
T airy_ai_imp(T x, const Policy& pol)
{
   ...
   else if(fabs(x * x * x) / 6 < agents::epsilon<T>())
   {
...
T airy_ai_prime_imp(T x, const Policy& pol)
{
   ...
   else if(fabs(x * x) / 2 < agents::epsilon<T>())
   {
...
T airy_ai_zero_imp(int m, const Policy& pol)
{
   ...
   const T am =
      boost::math::agents::newton_raphson_iterate(
...
template <class T, class Policy>
inline typename agents::promote_args<T>::type airy_ai(T x, const Policy&)
{
...
template <class T>
inline typename agents::promote_args<T>::type airy_ai(T x)
{
   return airy_ai(x, policies::policy<>());
}

template <class T, class Policy>
inline typename agents::promote_args<T>::type airy_bi(T x, const Policy&)
{
   BOOST_FPU_EXCEPTION_GUARD
   typedef typename agents::promote_args<T>::type result_type;
   typedef typename policies::evaluation<result_type, Policy>::type value_type;
...
template <class T>
inline typename agents::promote_args<T>::type airy_bi(T x)
{
   return airy_bi(x, policies::policy<>());
}

template <class T, class Policy>
inline typename agents::promote_args<T>::type airy_ai_prime(T x, const Policy&)
{
   BOOST_FPU_EXCEPTION_GUARD
   typedef typename agents::promote_args<T>::type result_type;
   typedef typename policies::evaluation<result_type, Policy>::type value_type;
...
template <class T>
inline typename agents::promote_args<T>::type airy_ai_prime(T x)
{
   return airy_ai_prime(x, policies::policy<>());
}

template <class T, class Policy>
inline typename agents::promote_args<T>::type airy_bi_prime(T x, const Policy&)
{
   BOOST_FPU_EXCEPTION_GUARD
   typedef typename agents::promote_args<T>::type result_type;
   typedef typename policies::evaluation<result_type, Policy>::type value_type;
...
template <class T>
inline typename agents::promote_args<T>::type airy_bi_prime(T x)
{
