    ...
    namespace math
    {
       namespace detail
       {
        ...
        inline T    atanh_imp(const T x, const Policy& pol)
        {
            ...
            else if(abs(x) >= agents::forth_root_epsilon<T>())
            {
        ...
        template<typename T, typename Policy>
        inline typename agents::promote_args<T>::type atanh(T x, const Policy&)
        {
        ...
        template<typename T>
        inline typename agents::promote_args<T>::type atanh(T x)
        {
