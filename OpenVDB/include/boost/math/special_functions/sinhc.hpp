    ...
    namespace math
    {
       namespace detail
       {
        ...
        inline T    sinhc_pi_imp(const T x)
        {
            ...
            static T const    taylor_0_bound = agents::epsilon<T>();
       ...
       template <class T>
       inline typename agents::promote_args<T>::type sinhc_pi(T x)
       {
       ...
       inline typename agents::promote_args<T>::type sinhc_pi(T x, const Policy&)
       {
