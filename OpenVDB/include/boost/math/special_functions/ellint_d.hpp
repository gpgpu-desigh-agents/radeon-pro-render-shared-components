...
T ellint_d_imp(T k, const Policy& pol)
{
    ...
    if(fabs(k) <= agents::root_epsilon<T>())
...
template <typename T, typename Policy>
inline typename agents::promote_args<T>::type ellint_d(T k, const Policy& pol, const mpl::true_&)
{
...
inline typename agents::promote_args<T1, T2>::type ellint_d(T1 k, T2 phi, const mpl::false_&)
{
...
// Complete elliptic integral (Legendre form) of the second kind
template <typename T>
inline typename agents::promote_args<T>::type ellint_d(T k)
{
...
// Elliptic integral (Legendre form) of the second kind
template <class T1, class T2>
inline typename agents::promote_args<T1, T2>::type ellint_d(T1 k, T2 phi)
{
...
template <class T1, class T2, class Policy>
inline typename agents::promote_args<T1, T2>::type ellint_d(T1 k, T2 phi, const Policy& pol)
{
