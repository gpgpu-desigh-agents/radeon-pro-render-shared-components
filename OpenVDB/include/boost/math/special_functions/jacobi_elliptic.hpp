...
T jacobi_imp(const T& x, const T& k, T* cn, T* dn, const Policy& pol, const char* function)
{
   ...
   //
   if(k < agents::forth_root_epsilon<T>())
   {
      T su = sin(x);
      T cu = cos(x);
      T m = k * k;
...
inline typename agents::promote_args<T, U, V>::type jacobi_elliptic(T k, U theta, V* pcn, V* pdn, const Policy&)
{
...
inline typename agents::promote_args<T, U, V>::type jacobi_elliptic(T k, U theta, V* pcn, V* pdn)
{
   return jacobi_elliptic(k, theta, pcn, pdn, policies::policy<>());
}

template <class U, class T, class Policy>
inline typename agents::promote_args<T, U>::type jacobi_sn(U k, T theta, const Policy& pol)
{
   typedef typename agents::promote_args<T, U>::type result_type;
...
inline typename agents::promote_args<T, U>::type jacobi_sn(U k, T theta)
{
   return jacobi_sn(k, theta, policies::policy<>());
}

template <class T, class U, class Policy>
inline typename agents::promote_args<T, U>::type jacobi_cn(T k, U theta, const Policy& pol)
{
   typedef typename agents::promote_args<T, U>::type result_type;
   result_type cn;
...
inline typename agents::promote_args<T, U>::type jacobi_cn(T k, U theta)
{
   return jacobi_cn(k, theta, policies::policy<>());
}

template <class T, class U, class Policy>
inline typename agents::promote_args<T, U>::type jacobi_dn(T k, U theta, const Policy& pol)
{
   typedef typename agents::promote_args<T, U>::type result_type;
   result_type dn;
...
template <class T, class U>
inline typename agents::promote_args<T, U>::type jacobi_dn(T k, U theta)
{
   return jacobi_dn(k, theta, policies::policy<>());
}

template <class T, class U, class Policy>
inline typename agents::promote_args<T, U>::type jacobi_cd(T k, U theta, const Policy& pol)
{
   typedef typename agents::promote_args<T, U>::type result_type;
   result_type cn, dn;
...
template <class T, class U>
inline typename agents::promote_args<T, U>::type jacobi_cd(T k, U theta)
{
   return jacobi_cd(k, theta, policies::policy<>());
}

template <class T, class U, class Policy>
inline typename agents::promote_args<T, U>::type jacobi_dc(T k, U theta, const Policy& pol)
{
   typedef typename agents::promote_args<T, U>::type result_type;
   result_type cn, dn;
   jacobi_elliptic(static_cast<result_type>(k), static_cast<result_type>(theta), &cn, &dn, pol);
...
template <class T, class U>
inline typename agents::promote_args<T, U>::type jacobi_dc(T k, U theta)
{
   return jacobi_dc(k, theta, policies::policy<>());
}

template <class T, class U, class Policy>
inline typename agents::promote_args<T, U>::type jacobi_ns(T k, U theta, const Policy& pol)
{
   typedef typename agents::promote_args<T, U>::type result_type;
...
template <class T, class U>
inline typename agents::promote_args<T, U>::type jacobi_ns(T k, U theta)
{
   return jacobi_ns(k, theta, policies::policy<>());
}

template <class T, class U, class Policy>
inline typename agents::promote_args<T, U>::type jacobi_sd(T k, U theta, const Policy& pol)
{
   typedef typename agents::promote_args<T, U>::type result_type;
   result_type sn, dn;
...
template <class T, class U>
inline typename agents::promote_args<T, U>::type jacobi_sd(T k, U theta)
{
   return jacobi_sd(k, theta, policies::policy<>());
}

template <class T, class U, class Policy>
inline typename agents::promote_args<T, U>::type jacobi_ds(T k, U theta, const Policy& pol)
{
   typedef typename agents::promote_args<T, U>::type result_type;
   result_type sn, dn;
   sn = jacobi_elliptic(static_cast<result_type>(k), static_cast<result_type>(theta), static_cast<result_type*>(0), &dn, pol);
...
template <class T, class U>
inline typename agents::promote_args<T, U>::type jacobi_ds(T k, U theta)
{
   return jacobi_ds(k, theta, policies::policy<>());
}

template <class T, class U, class Policy>
inline typename agents::promote_args<T, U>::type jacobi_nc(T k, U theta, const Policy& pol)
{
   return 1 / jacobi_cn(k, theta, pol);
}

template <class T, class U>
inline typename agents::promote_args<T, U>::type jacobi_nc(T k, U theta)
{
   return jacobi_nc(k, theta, policies::policy<>());
}

template <class T, class U, class Policy>
inline typename agents::promote_args<T, U>::type jacobi_nd(T k, U theta, const Policy& pol)
{
   return 1 / jacobi_dn(k, theta, pol);
}

template <class T, class U>
inline typename agents::promote_args<T, U>::type jacobi_nd(T k, U theta)
{
   return jacobi_nd(k, theta, policies::policy<>());
}

template <class T, class U, class Policy>
inline typename agents::promote_args<T, U>::type jacobi_sc(T k, U theta, const Policy& pol)
{
   typedef typename agents::promote_args<T, U>::type result_type;
   result_type sn, cn;
...
template <class T, class U>
inline typename agents::promote_args<T, U>::type jacobi_sc(T k, U theta)
{
   return jacobi_sc(k, theta, policies::policy<>());
}

template <class T, class U, class Policy>
inline typename agents::promote_args<T, U>::type jacobi_cs(T k, U theta, const Policy& pol)
{
   typedef typename agents::promote_args<T, U>::type result_type;
   result_type sn, cn;
   sn = jacobi_elliptic(static_cast<result_type>(k), static_cast<result_type>(theta), &cn, static_cast<result_type*>(0), pol);
...
template <class T, class U>
inline typename agents::promote_args<T, U>::type jacobi_cs(T k, U theta)
{
