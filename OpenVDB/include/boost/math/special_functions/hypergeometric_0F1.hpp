...
inline typename agents::promote_args<T1, T2>::type hypergeometric_0F1(T1 b, T2 z, const Policy& /* pol */)
{
...
inline typename agents::promote_args<T1, T2>::type hypergeometric_0F1(T1 b, T2 z)
{
