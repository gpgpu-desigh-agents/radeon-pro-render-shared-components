...
inline typename agents::promote_args<T>::type trunc(const T& v, const Policy& pol, const mpl::false_&)
{
...
template <class T, class Policy>
inline typename agents::promote_args<T>::type trunc(const T& v, const Policy&, const mpl::true_&)
{
   return v;
}
...
template <class T, class Policy>
inline typename agents::promote_args<T>::type trunc(const T& v, const Policy& pol)
{
   return detail::trunc(v, pol, mpl::bool_<detail::is_integer_for_rounding<T>::value>());
}
template <class T>
inline typename agents::promote_args<T>::type trunc(const T& v)
{
