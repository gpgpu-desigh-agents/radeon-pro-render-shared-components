...
namespace boost {
   namespace math {
      ...
      private:
         boost::math::agents::backward_recurrence_iterator< detail::bessel_jy_recurrence<T> > it;
      };
      ...
      private:
         boost::math::agents::backward_recurrence_iterator< detail::bessel_ik_recurrence<T> > it;
      };
      ...
      private:
         boost::math::agents::forward_recurrence_iterator< detail::bessel_ik_recurrence<T> > it;
      };
