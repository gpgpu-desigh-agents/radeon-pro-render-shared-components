...
template <typename T, typename Policy>
inline typename agents::promote_args<T>::type ellint_1(T k, const Policy& pol, const mpl::true_&)
{
...
inline typename agents::promote_args<T1, T2>::type ellint_1(T1 k, T2 phi, const mpl::false_&)
{
...
// Complete elliptic integral (Legendre form) of the first kind
template <typename T>
inline typename agents::promote_args<T>::type ellint_1(T k)
{
...
// Elliptic integral (Legendre form) of the first kind
template <class T1, class T2, class Policy>
inline typename agents::promote_args<T1, T2>::type ellint_1(T1 k, T2 phi, const Policy& pol)
{
...
template <class T1, class T2>
inline typename agents::promote_args<T1, T2>::type ellint_1(T1 k, T2 phi)
{
