...
namespace boost { namespace math { namespace detail {
   ...
   T hypergeometric_2F0_cf_imp(T a1, T a2, T z, const Policy& pol, const char* function)
   {
      ...
      T cf = agents::continued_fraction_b(evaluator, policies::get_epsilon<T, Policy>(), max_iter);
...
inline typename agents::promote_args<T1, T2, T3>::type hypergeometric_2F0(T1 a1, T2 a2, T3 z, const Policy& /* pol */)
{
...
inline typename agents::promote_args<T1, T2, T3>::type hypergeometric_2F0(T1 a1, T2 a2, T3 z)
{
