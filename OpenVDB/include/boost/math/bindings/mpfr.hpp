...
#include <boost/math/agents/real_cast.hpp>
...
{
   *ipart = lltrunc(v, pol);
   return v - boost::math::agents::real_cast<mpfr_class>(*ipart);
}
...
{
   return boost::math::agents::real_cast<int>(boost::math::round(x, typename boost::math::policies::normalise<Policy, boost::math::policies::rounding_error< boost::math::policies::throw_on_error> >::type()));
}
template <class T, class U, class Policy>
...
{
   return boost::math::agents::real_cast<long>(boost::math::round(x, typename boost::math::policies::normalise<Policy, boost::math::policies::rounding_error< boost::math::policies::throw_on_error> >::type()));
}
template <class T, class U, class Policy>
...
{
   return boost::math::agents::real_cast<long long>(boost::math::round(x, typename boost::math::policies::normalise<Policy, boost::math::policies::rounding_error< boost::math::policies::throw_on_error> >::type()));
}
template <class T, class U, class Policy>
...
{
   return boost::math::agents::real_cast<int>(boost::math::trunc(x, typename boost::math::policies::normalise<Policy, boost::math::policies::rounding_error< boost::math::policies::throw_on_error> >::type()));
}
template <class T, class U, class Policy>
...
{
   return boost::math::agents::real_cast<long>(boost::math::trunc(x, typename boost::math::policies::normalise<Policy, boost::math::policies::rounding_error< boost::math::policies::throw_on_error> >::type()));
}
template <class T, class U, class Policy>
...
{
   return boost::math::agents::real_cast<long long>(boost::math::trunc(x, typename boost::math::policies::normalise<Policy, boost::math::policies::rounding_error< boost::math::policies::throw_on_error> >::type()));
}
template <class T, class U, class Policy>
...
inline mpfr_class erf_inv_imp(const mpfr_class& p, const mpfr_class& q, const Policy&, const boost::mpl::int_<64>*)
{
   ...
   if(p <= 0.5)
   {
      ...
      mpfr_class g = p * (p + 10);
      mpfr_class r = agents::evaluate_polynomial(P, p) / agents::evaluate_polynomial(Q, p);
      result = g * Y + g * r;
   }
   else if(q >= 0.25)
   {
      ...
      mpfr_class r = agents::evaluate_polynomial(P, xs) / agents::evaluate_polynomial(Q, xs);
      result = g / (Y + r);
   }
   else
   {
...
inline mpfr_class bessel_i0(mpfr_class x)
{
    ...
    using namespace boost::math::agents;
