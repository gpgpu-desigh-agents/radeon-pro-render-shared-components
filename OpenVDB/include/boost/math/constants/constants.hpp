...
#include <boost/math/agents/convert_from_string.hpp>
#ifdef BOOST_MSVC
#pragma warning(push)
...
#define BOOST_DEFINE_MATH_CONSTANT(name, x, y)\
   ...
   {\
      static const T result(boost::math::agents::convert_from_string<T>(y));\
      return result;\
   }\
   ...
   {\
      ...
      int current_digits = boost::math::agents::digits<T>();\
      if(digits != current_digits)\
      {\
         value = current_digits > max_string_digits ? compute<0>() : T(boost::math::agents::convert_from_string<T>(y));\
