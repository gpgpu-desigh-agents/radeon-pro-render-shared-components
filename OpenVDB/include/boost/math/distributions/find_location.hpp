...
#include <boost/math/agents/traits.hpp>
...
namespace boost
{
  ...
  // enforced by BOOST_STATIC_ASSERT below.
      ...
      )
    {
      ...
      BOOST_STATIC_ASSERT(::boost::math::agents::is_distribution<Dist>::value); 
      BOOST_STATIC_ASSERT(::boost::math::agents::is_scaled_distribution<Dist>::value);
#endif
