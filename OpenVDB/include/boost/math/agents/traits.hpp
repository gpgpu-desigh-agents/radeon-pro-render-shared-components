...
/*
This header defines two traits classes, both in namespace boost::math::agents.
...
{
   BOOST_STATIC_CONSTANT(bool, value = (::boost::math::agents::detail::is_scaled_distribution_helper<D, ::boost::math::agents::detail::is_distribution_imp<D>::value>::value));
};

} // namespace detail

template <class T> struct is_distribution : public boost::integral_constant<bool, ::boost::math::agents::detail::is_distribution_imp<T>::value> {};
template <class T> struct is_scaled_distribution : public boost::integral_constant<bool, ::boost::math::agents::detail::is_scaled_distribution_imp<T>::value> {};
