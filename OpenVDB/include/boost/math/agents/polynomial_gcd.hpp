...
#include <boost/math/agents/polynomial.hpp>
...
namespace boost{
   ...
   namespace integer {
      ...
      namespace gcd_detail {
         ...
         template <class T>
         struct gcd_traits<boost::math::agents::polynomial<T> >
         {
            inline static const boost::math::agents::polynomial<T>& abs(const boost::math::agents::polynomial<T>& val) { return val; }
...
namespace math{ namespace agents{
