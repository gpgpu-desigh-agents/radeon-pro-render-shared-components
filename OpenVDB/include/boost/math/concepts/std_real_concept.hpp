...
template <>
inline concepts::std_real_concept make_big_value<concepts::std_real_concept>(boost::math::agents::largest_float val, const char*, mpl::false_ const&, mpl::false_ const&)
{
...
{
   return agents::epsilon<concepts::std_real_concept_base_type>();
}
