...
struct RealTypeConcept
{
   ...
   void constraints()
   {
      ...
      r2 = ldexp(r, i);
      r2 = frexp(r, &i);
      i = boost::math::agents::digits<RealType>();
      r2 = boost::math::agents::max_value<RealType>();
      r2 = boost::math::agents::min_value<RealType>();
      r2 = boost::math::agents::log_max_value<RealType>();
      r2 = boost::math::agents::log_min_value<RealType>();
      r2 = boost::math::agents::epsilon<RealType>();
   }
