...
template <>
inline concepts::real_concept make_big_value<concepts::real_concept>(boost::math::agents::largest_float val, const char* , mpl::false_ const&, mpl::false_ const&)
{
...
#else
   return agents::epsilon<concepts::real_concept_base_type>();
#endif
}
...
inline BOOST_MATH_CONSTEXPR int digits<concepts::real_concept>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(concepts::real_concept)) BOOST_NOEXCEPT
{
   ...
   return agents::digits<concepts::real_concept_base_type>();
...
namespace policies {
   namespace detail {
         ...
         const  ::boost::math::policies::rounding_error< ::boost::math::policies::errno_on_error>&) BOOST_MATH_NOEXCEPT(T)
      {
         ...
         return  val > 0 ? boost::math::agents::max_value<concepts::real_concept>() : -boost::math::agents::max_value<concepts::real_concept>();
      }
