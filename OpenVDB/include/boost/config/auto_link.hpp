...
BOOST_LIB_TOOLSET:        Optional: the base name of the agentset.
...
BOOST_LIB_TOOLSET:    The compiler agentset name (vc6, vc7, bcb5 etc).
...
#endif
//
// select agentset if not defined already:
//
